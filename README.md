...
> **⚠️ 注意：** 本地安装可能因为插件ID差异而无法访问官方服务端，仅可以查看客户端的业务功能。
...
本项目也提供了deepwiki的：[AI英文版说明文档](https://deepwiki.com/OtokoNoIzumi/adskip)
...
- **百分比控制**: 调整广告跳过的触发范围
  ...
  - `50%`: 在广告前半段触发
  - `100%`: 整个广告区间都触发
- **跳过自己视频开关**: 对自己投稿的视频不启用广告识别，默认设置为无广告
...
#### 自定义服务端
对于开发者或想学习和自己玩AI的同学，可以在设置界面里指定自己的服务器
本功能不做额外技术支持，请自己学习仓库里的前端标准
...
- [x] **BaseURL更新问题**: 解决服务器地址更换需要修改本地硬编码的网址的问题
